...
// import { useGetTreeDescription, useMakeGetFieldDef } from "@web/core/tree_editor/utils"; //not work
...
export class DomainFieldBits extends Component {
    ...
    static props = {
        ...
        countLimit: { type: Number, optional: true },        // Added
        allowExpressions: { type: Boolean, optional: true }, // Added
    };
    static defaultProps = {
        editInDialog: false,
        isFoldable: false,
        countLimit: 10000,        // Added
        allowExpressions: false,  // Added
    };
    ...
    async quickValidityCheck(props) {
        ...
        const domain = this.getEvaluatedDomain(props);
        if (domain.isInvalid) return false;
...
export const domainFieldBits = {
    ...
    supportedOptions: [
        ...
        {
            label: _t("Allow expressions"),        // Added
    ...
    extractProps({ options }, dynamicInfo) {
        return {
            ...
            allowExpressions: options.allow_expressions, // Added
