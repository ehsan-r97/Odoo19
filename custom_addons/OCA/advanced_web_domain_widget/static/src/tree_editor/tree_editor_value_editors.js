...
import { Input, InRange, List, Range, Select } from "./tree_editor_components";
...
function makeAutoCompleteEditor(fieldDef,resModel) {
    return {
        component: DomainSelectorAutocomplete,
        extractProps: ({ value, update }) => ({
            resModel: resModel || getResModel(fieldDef),
    ...
    switch (operator) {
        ...
        case "not in": {
            switch (fieldDef.type) {
                ...
                default: {
                    if (fieldDef.name === "id") {
                        return makeAutoCompleteEditor(fieldDef, params.resModel);
                    }
